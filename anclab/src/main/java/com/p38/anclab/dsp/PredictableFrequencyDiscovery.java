...
public final class PredictableFrequencyDiscovery {
    ...
    private static final int DECIMATED_RATE=48000/DECIMATION;
    ...
    public void observe(float sample,long nowMs){
    ...
    public void reset(){Arrays.fill(ring,0f);write=count=decimator=sinceUpdate=0;latest=new double[0];detector.reset();}
}
