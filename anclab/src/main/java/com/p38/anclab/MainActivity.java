...
public final class MainActivity extends Activity {
    ...
    private View buildInterface(){
        ...
        TextView subtitle=text("v0.6 development · predictive headphones + telemetry/sensor-learning vehicle ANC",11,MUTED);subtitle.setPadding(dp(18),0,dp(18),dp(10));shell.addView(subtitle);
